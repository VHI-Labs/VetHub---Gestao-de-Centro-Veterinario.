...
export default function Recepcao() {
  ...
  const agendados = allPets.filter(pet => pet.senha?.startsWith("A") && pet.status === "Aguardando direcionamento")
          ...
          <div className="queue-layout" style={{ display: "flex", flexDirection: "column", gap: 12, overflowY: "auto", flex: 1, paddingBottom: 20 }}>
            {agendados.length === 0 ? (
              <div className="antigravity-card" style={{ padding: 40, textAlign: "center", color: "var(--text-light)", fontSize: "1.1rem" }}>
                🐾 Não há pacientes agendados na fila aguardando no momento.
              </div>
            ) : (
              agendados.map(pet => (
                <PetListRow
        ...
        <div style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20, marginBottom: 30 }}>
            <div className="antigravity-card" style={{ padding: 20, display: "flex", alignItems: "center", gap: 16, borderLeft: "5px solid #3b82f6" }}>
              <div style={{ width: 46, height: 46, borderRadius: 12, background: "rgba(59,130,246,0.1)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.3rem" }}>🐶</div>
              <div>
            ...
            <div className="antigravity-card" style={{ padding: 20, display: "flex", alignItems: "center", gap: 16, borderLeft: "5px solid #ec4899" }}>
              <div style={{ width: 46, height: 46, borderRadius: 12, background: "rgba(236,72,153,0.1)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.3rem" }}>🐱</div>
              <div>
            ...
            <div className="antigravity-card" style={{ padding: 20, display: "flex", alignItems: "center", gap: 16, borderLeft: "5px solid #10b981" }}>
              <div style={{ width: 46, height: 46, borderRadius: 12, background: "rgba(16,185,129,0.1)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.3rem" }}>🦜</div>
              <div>
