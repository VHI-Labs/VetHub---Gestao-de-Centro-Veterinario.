...
# Real user sessions for HOVET.2 (not checkpoint-writer subagent sessions)
user_sessions = [
    "ses_0a2d4eee6ffeWoOiuXqhYu2X8J",  # Responsividade
    "ses_0a4a5e3f3ffeWv19JsbuI667y1",  # CI/CD
    "ses_0a64263aeffe4K4fQooR23O8eI",  # Migração
    "ses_0a766c41affeumKVI4pME1UjvT",  # NSI texto
    "ses_113834b71ffeYifk6V90GzsI7F",  # Prontuário build
]
...
for sid in user_sessions:
    ...
    if s:
        ...
        print(f"Directory: {data.get('directory', 'N/A')}")

    # Get user messages (key statements, decisions, rules)
    cur.execute("""
